...
public interface RaceRegistrationRepository extends JpaRepository<RaceRegistration, Integer> {
    ...
    @Query(value = "SELECT racer.NAME rc, racer.surname, team.NAME AS tean_name, car.label, car.model FROM race_registration race\n" +
            ...
            " UNION\n" +
            "SELECT racer.NAME , racer.surname, team.NAME AS tean_name, car.label, car.model FROM race_registration race\n" +
